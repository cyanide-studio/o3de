...
namespace AZ
{
        ...
        AZStd::vector<char>& scratchBuffer)
    {
        ...
        // @CYA EDIT: This will cause asset bundles manifest to load too early, breaking asset loading, see
        // https://github.com/o3de/o3de/issues/13473 For each merged settings key, signal the notifier event
        //
